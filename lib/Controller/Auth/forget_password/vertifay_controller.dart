...
import '../../../Data/Data Source/Remote/auth/forget_password/vertifay_data.dart';

class VertifayController extends GetxController {
  GlobalKey<FormState> formKey = GlobalKey();
  TextEditingController email = TextEditingController();
  StatusRequest statusRequest = StatusRequest.none;
  VertifayData vertifayData = VertifayData(Get.find());
